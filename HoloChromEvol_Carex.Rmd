...
mu.h.s <- sigmoid.x(states.seq, chrom.mle.h.s$par[5], chrom.mle.h.s$par[6], chrom.mle.h.s$par[7], chrom.mle.h.s$par[8])
plot(states.seq, mu.h.s, type = "l")

lambda.h.s <- noroptimal.x(states.seq, chrom.mle.h.s$par[1], chrom.mle.h.s$par[2], chrom.mle.h.s$par[3], chrom.mle.h.s$par[4])
plot(states.seq, lambda.h.s, type = "l")

plot(states.seq, mu.h.s, type = "l")
lines(states.seq, lambda.h.s, type = "l")
